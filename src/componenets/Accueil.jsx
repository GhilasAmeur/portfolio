...
const Accueil = () => {
  ...
  <TypeAnimation
    sequence={[
      'Bonjour 😊', 2000,
      'Bienvenue sur mon site ⌨', 2000,
      'Explorez et amusez-vous !', 2000,
    ]}
    wrapper="span"
    speed={50}
    repeat={Infinity}
  />
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          intuitives. J’utilise principalement <span className="text-purple-400">React</span> et{" "}
       ...
       <a  href="mecontacter"><button className="mt-4 bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-full transition duration-300">
          Me contacter
        </button></a> 
      </div>
